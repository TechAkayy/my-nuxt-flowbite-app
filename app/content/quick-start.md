# Vue Designer Nuxt Flowbite - Quick start template
...
Demo - https://pg-nuxt-flowbite.netlify.app/
...
[Create a repo from this template on GitHub](https://github.com/pinegrow/pg-nuxt-flowbite/generate).
...
```bash
npx giget@latest gh:pinegrow/pg-nuxt-flowbite my-nuxt-flowbite-app #project-name
cd my-nuxt-flowbite-app
...
```bash
npx giget@latest gh:pinegrow/pg-nuxt-flowbite#blank my-nuxt-flowbite-app #project-name
cd my-nuxt-flowbite-app
npm install #or use pnpm
```
...
[![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/Pinegrow/pg-nuxt-flowbite)
